...
Lokal GPX → transparent video. Mörkt webbgränssnitt, valbara mätvärden och samma renderare för förhandsvisning och export.

## Uppdatering: tydligare uppladdning
...
2. Välj hastighet, puls, effekt, kadens, elapsed time, distans, höjd och/eller temperatur. Anpassa textstorlek, rad/stapel, placering, symbolfärg och kontur.
...
4. Välj yta: **3840 × 2160**, kompakt **3840 × 540**, eller **1920 × 1080**. Välj 1, 2, 3 eller 5 fps.
...
- **MOV / ProRes 4444** är förstahandsvalet att prova i en videoeditor. Det har en riktig alfakanal och kan ge stora filer.
- **WebM / VP9 alpha** har också riktig transparens och blir ofta mindre. Stödet varierar mellan redigeringsprogram.
- MP4/H.264 erbjuds inte eftersom det inte ger den alfakanal som denna app behöver.
- Schackrutorna exporteras aldrig. Endast text, symboler och vald textkontur syns i videon.
...
I `examples/` finns två riktiga 3-sekunders överlägg från din Björsäter-fil, vid elapsed 00:00:15–00:00:18, i 4K/2 fps. De innehåller bara siffror och symboler, ingen karta eller GPS-position.
...
- `rendering.py`: transparent Pillow-rendering och konfigurationsvalidering.
